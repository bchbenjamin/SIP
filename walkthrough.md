...
- The `train_weapon.py` configuration was fully populated with the correct API keys and setup sequence requirements.

Please look at [README.md](README.md) for how to use the applications.
